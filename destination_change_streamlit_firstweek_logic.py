...
st.set_page_config(page_title="Destination Change Builder", page_icon="📦", layout="wide")
...
with st.expander("Logic đang áp dụng", expanded=True):
    st.markdown(
        '''
- **Whse = 335**  
  `Sum of SI Wk3 = SHIPPABLE INV tại Target Week - Total PLANNED POS từ tuần đầu tiên trong file đến Target Week - FIRM POS tại Target Week + Total NET FCST từ Current Week đến Target Week`

- **Whse <> 335**  
  `Sum of SI Wk3 = SHIPPABLE INV tại Target Week - Total PLANNED POS từ tuần đầu tiên trong file đến Target Week - FIRM POS tại Target Week`
    ...
    if uploaded_file is None:
        ...
        try:
            with st.spinner("Đang xử lý dữ liệu..."):
                ...
                output_df, debug_df = transform_df(raw, target_week, current_week)
